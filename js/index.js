...
} else if (localStorage.getItem("currentWordIndex") === undefined) {
...
function updateWrong() {
  ...
  if (studyListArray.includes(word)) {
    ...
    localStorage.setItem("studyListArray", studyListArray);
  }
}
...
function updateRecord() {
  if (hasStorage) {
    recordCount = Number(localStorage.getItem("recordScore"));
    recordCount++;
    localStorage.setItem("recordScore", recordCount);
  } else {
    recordCount++;
  }
  $("#recordScore").html(recordCount);
